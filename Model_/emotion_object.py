...
class EmotionAnalysis :
    def analyze_emotion(self):
        ...
        prepro_configs = json.load(open('./NLP/Model_/data/CLEAN_DATA/'+DATA_CONFIGS,'r'))
        ...
        '''
        with open('./NLP/Model_/model.pkl', 'rb') as model_file:
            model = pickle.load(model_file)
        '''
        model = load_model('./NLP/Model_/')
        model.load_weights('./NLP/Model_/data/DATA_OUT/cnn_classifier_kr/weights.h5')
